...
const Skills = (p) => {
    ...
    const getData = (p = {}) => {
        ...
        ApiClient.get('api/skills/listing', filter).then(res => {
            if (res.success) {
    ...
    const deleteItem = (id) => {
        ...
        //     loader(true)
        //     ApiClient.delete('api/skill/delete', { id: id }).then(res => {
        //         if (res.success) {
    ...
    const statusChange = (itm) => {
        ...
        //     loader(true)
        //     ApiClient.put(`api/skill/status/change`, { id: itm.id, status }).then(res => {
        //         if (res.success) {
        //             getData()
        //         }
        //         loader(false)
