...
const AddEdit = () => {
    ...
    useEffect(() => {
        if (id) {
            loader(true)
            ApiClient.get('api/skill/detail', { id }).then(res => {
                if (res.success) {
                    let value = res.data
                    let payload = form
                ...
                <div className="pprofile1">
                    ...
                    <div className='flex items-center mb-8'>
                        <Tooltip placement="top" title="Back">
                            ...
                            <Link to="/skills" className="!px-4  py-2 flex items-center justify-center  rounded-lg shadow-btn hover:bg-[#F3F2F5] border transition-all  mr-3"><i className='fa fa-angle-left text-lg'></i></Link>
                        </Tooltip>
                        <div>
                        ...
                        {/* <div className="col-md-6 mb-3">
                            ...
                            <div className="custom_dropdown">
                                <SelectDropdown
                                    id="statusDropdown"
                                    displayValue="name"
                                    intialValue={form.skillRole}
                                    result={e => { setform({ ...form, skillRole: e.value }) }}
                                    options={roles}
                                    theme="search"
                                />
