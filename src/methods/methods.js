...
const flagIcon=(icon='',width=50)=>{
    ...
    return <>
            <img src={`https://flagsapi.com/${icon?.toUpperCase()}/flat/64.png`} width={width} onError={imageErr} />   
    </>
}

const methodModel = { userImg,route,flagIcon, isNumber, isRatio, find, getError, getFormError, getPrams, emailRequiredFor, emailvalidation, noImg, isTranslatePage, generatekeysArr }
